...
const SupportModal = ({ userName, onClose }) => {
  return (
    <div className="fixed inset-0 bg-gray-700/50 overflow-y-auto h-full w-full flex justify-center items-center z-50">
      <div className="relative p-8 bg-white w-96 mx-auto rounded-md shadow-lg text-center">
        ...
        <button
          onClick={onClose}
          className="mt-4 block mx-auto bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded-md transition duration-200"
        >
          Close
        </button>
      </div>
